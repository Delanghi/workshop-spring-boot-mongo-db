...
public class Instanciation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("24/02/2019"), "Partiu viagem!", "Vou viajar para São Paulo. Abraços!", maria);
		Post post2 = new Post(null, sdf.parse("28/02/2019"), "Bom dia!", "Acordei hoje feliz!", maria);
